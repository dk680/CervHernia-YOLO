...
def bbox_iou(box1, box2, xywh=False, GIoU=False, DIoU=False, CIoU=False, EIoU=False, SIoU=False, WIoU=False,
             ShapeIoU=True, hw=1, mpdiou=False, Inner=True, Focaleriou=False, d=0.00, u=0.95, ratio=0.7,
             eps=1e-7, scale=0.0):
    """
